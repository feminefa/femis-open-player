package orimi.com.ng.kure.musicplayer;

import java.util.ArrayList;

import orimi.com.ng.kure.musicplayer.model.Song;
import orimi.com.ng.kure.musicplayer.services.ServicePlayMusic;
import orimi.com.ng.core.libs.Logger;
import orimi.com.ng.kure.musicplayer.model.SongList;
...
public class kMP {
	...
	public static String applicationName = "Orimi Music Player";
	...
	public static ServiceConnection musicConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if(musicService!=null)        Logger.write("Music service started");
		};

		@Override
		public void onServiceDisconnected(ComponentName name) {
			musicService.musicBound = false;
            //Logger.write("Music service stopped");
		}
	};
	...
	public static void startMusicService(Context c) {
		...
		if (musicServiceIntent != null) {
            //Logger.write("Not null");
            return;
        }

		if (kMP.musicService != null)
			return;
        Logger.write("Starting music service");
	...
	public static void stopMusicService(Context c) {
        ...
        Logger.write("Stopping music service");
	}
}
