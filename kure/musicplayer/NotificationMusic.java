...
import orimi.com.ng.kure.musicplayer.activities.ActivityNowPlaying;
...
public class NotificationMusic extends NotificationSimple {
	...
	public void notifySong(Context context, Service service, Song song) {
		...
		notificationBuilder.setContentIntent(pendingIntent)
		                   ...
		                   .setTicker("Orimi: Playing '" + song.getTitle() + "' from '" + song.getArtist() + "'")
		                   .setOngoing(true)
		...
		//service.startstartForeground(NOTIFICATION_ID, notification);
	}
