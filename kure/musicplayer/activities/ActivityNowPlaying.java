package orimi.com.ng.kure.musicplayer.activities;

import orimi.com.ng.kure.musicplayer.MusicController;
import orimi.com.ng.kure.musicplayer.adapters.AdapterSong;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null) {
			...
			if (bundle.containsKey("song")) {
				int songToPlayIndex = (int) bundle.getInt("song");
