package orimi.com.ng.kure.musicplayer.services;
...
import orimi.com.ng.kure.musicplayer.model.Song;
import orimi.com.ng.kure.musicplayer.NotificationMusic;
import orimi.com.femi.R;
import orimi.com.ng.kure.musicplayer.kMP;
import orimi.com.ng.kure.musicplayer.external.RemoteControlClientCompat;
import orimi.com.ng.kure.musicplayer.external.RemoteControlHelper;
...
public class ServicePlayMusic extends Service
	 ...
	 */
	public static final String BROADCAST_ACTION = "orimi.com.ng.kure.musicplayer.MUSIC_SERVICE";
	...
	public void onPrepared(MediaPlayer mp) {
      ...
      /*  Intent intent = new Intent(ServicePlayMusic.BROADCAST_EXTRA_PLAYING);
       // intent.setAction("orimi.com.ng.core.activities.MainActivity");
...
*/
	...
	public void next(boolean userSkippedSong) {
		...
		if (shuffleMode) {
			...
			while (songs.size() > 1 && newSongPosition == currentSongPosition) {
	...
	public void broadcastState(String state) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)
           ...
           // Logger.write(TAG, "sentBroadcast");
