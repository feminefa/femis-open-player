...
public class Settings {
    ...
    public void set(String key, int defaultValue) {
        if (preferences == null) {
          ...
          else  preferences.edit().putInt(key, defaultValue).commit();
    }
    public void set(String key, String defaultValue) {
        if (preferences == null) {

        }
        else  preferences.edit().putString(key, defaultValue).commit();
    ...
    public void set(String key, boolean defaultValue) {
        ...
        else  preferences.edit().putBoolean(key, defaultValue).commit();
