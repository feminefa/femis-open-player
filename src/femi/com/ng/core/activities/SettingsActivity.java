		...
		for(int x = 0; x < getPreferenceScreen().getPreferenceCount(); x++) {
			...
			for (int y = 0; y < category.getPreferenceCount(); y++) {
                ...
                if (preference.getKey().equals("about")) {
                    preference.setSummary("Femi's Open Player (FOP) is free for all. Do not hesitate to report bugs and request new features. Click here to follow me on twitter (@feminefa). Enjoy!!!");
                }
	...
	public OnPreferenceClickListener onClickPreference = new OnPreferenceClickListener() {
		...
		public boolean onPreferenceClick(Preference pref) {
			...
			if /* */(/* * */pref/* */./* * * * * * * */getKey/* */(/* */)/* */.equals/* */(/* */"version"/* */)/* */) /* */{
              ...
              //  if(brianGriffin >= 5) {
                    //brianGriffin = 0;
                    //startActivity(new Intent(SettingsActivity.this, XXX.class));
                //}
            }
            if(pref.getKey().equals("about")) {
               startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/feminefa")));
            }
